...
const zhCN: Record<MessageKey, string> = {
  ...
  "clips.heading": "片段候选", "clips.generate": "生成候选", "clips.generateRender": "生成并渲染", "clips.part": "段落", "clips.count": "{{count}} 个候选", "clips.notGenerated": "暂无候选", "clips.generating": "正在生成候选…", "clips.generatingRender": "正在生成候选并渲染文件…", "clips.running": "任务运行中 · SSE 实时", "clips.rank": "排名", "clips.window": "区间", "clips.score": "分数", "clips.excerpt": "摘录", "clips.actions": "操作", "deliverables.heading": "成品文件", "deliverables.loading": "加载成品文件…", "deliverables.none": "暂无最终 MP3，请先运行完整处理流程。", "deliverables.final": "最终输出", "deliverables.downloadMp3": "下载 MP3", "deliverables.chapters": "章节", "deliverables.editedParts": "已编辑段落", "deliverables.notProduced": "尚未生成", "deliverables.openReport": "打开 RUN_REPORT.md",
